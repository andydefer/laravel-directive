...
// src/Strategies/HelpExecutionStrategy.php
...
final class HelpExecutionStrategy implements ExecutionStrategyInterface
{
    ...
    {
        return $record->signature === '--help' || $record->signature === '-h';
    }
